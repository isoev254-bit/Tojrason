// Tojrason/frontend/courier/src/utils/formatPrice.ts
/*
...
/**
 * Табдили маблағ ба ҳарф (ба забони тоҷикӣ) - версияи сода
 * @param amount - Маблағ
...
/**
 * Форматкунии даромади курйер барои намоиш дар панели асосӣ
 * @param amount - Маблағ
 * @returns Сатри форматшуда барои намоиши зуд
 */
export const formatEarnings = (amount: number | string | null | undefined): string => {
  if (amount === null || amount === undefined) return '0 смн';
  
  const num = typeof amount === 'string' ? parseFloat(amount) : amount;
  if (isNaN(num)) return '0 смн';
