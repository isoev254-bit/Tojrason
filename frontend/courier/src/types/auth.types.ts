// Tojrason/frontend/courier/src/types/auth.types.ts
/*
...
/**
 * Интерфейси асосии корбар (версияи умумӣ)
 */
...
/**
 * Маълумоти бақайдгирии курйери нав
 */
...
/**
 * Статуси тасдиқи ҳуҷҷатҳои курйер
 */
export interface CourierDocumentStatus {
  idCard: boolean;
...
/**
 * Дархости боргузории ҳуҷҷат
 */
export interface UploadDocumentRequest {
  documentType: 'idCard' | 'driverLicense' | 'vehicleRegistration' | 'insurance';
  file: File;
}

/**
 * Ҷавоби боргузории ҳуҷҷат
 */
