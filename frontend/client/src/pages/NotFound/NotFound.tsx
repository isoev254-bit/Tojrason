// Tojrason/frontend/client/src/pages/NotFound/NotFound.tsx
/*
      ...
      <div className="w-full max-w-md">
        ...
        >
          <Card className="p-8 text-center">
            ...
            >
              Ба кӯмак ниёз доред?{' '}
              <Link to="/contact" className="text-indigo-600 hover:text-indigo-700 hover:underline">
          ...
          >
            <Link to="/" className="inline-block">
              <span className="text-2xl font-bold text-indigo-600">Тоҷрасон</span>
            </Link>
          </motion.div>
        </motion.div>
      </div>
